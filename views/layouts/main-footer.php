    ...
    <footer class="footer">
        <div class="footer__inner container">
            <div class="footer__body">
                ...
                <nav class="footer__menu grid grid--3">
                    ...
                    <div class="footer-contacts">
                        <ul class="footer-contacts__list">
                            <li class="footer-contacts__item">
                                ...
                                <a href="tel8(7282)41-36-35" class="footer-contacts__link phone-number">
                            ...
                            <li class="footer-contacts__item">
                                ...
                                <a href="#" class="footer-contacts__link location" target="_blank">
