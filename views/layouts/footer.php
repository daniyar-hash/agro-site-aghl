    ...
    <footer class="footer">
        <div class="footer__inner container">
            <div class="footer__body">
                <div class="footer__logo-and-coopyright">
                    <h2 class="footer__column-title h4 visually-hidden">Logotype and coopyright</h2>
                    <a href="/" class="footer__logo logo">
                     <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                       viewBox="0 0 457.000000 296.000000"
                ...
                <nav class="footer__menu">
                    <div class="footer__column">
                        <h2 class="footer__column-title h4">Компания</h2>
                        <ul class="footer__column-list">
                                <li class="footer--column-item">
                                    <a href="/" class="footer__column-link">Лицензии</a>
                                </li>   
                                <li class="footer--column-item">
                                    <a href="/" class="footer__column-link">Партнеры</a>
                                </li>   
                            
                                <li class="footer--column-item">
                                    <a href="/" class="footer__column-link">Реквизиты</a>
                                </li>   
                            </ul>
                    </div>
                 <div class="footer__column">
                ...
                <div class="footer__column">
                     <h2 class="footer__column-title h4">Контакты</h2>

                    <div class="footer-contacts">
                        <ul class="footer-contacts__list">
                            <li class="footer-contacts__item">
                                <span class="visually-hidden">Phone-number</span>
                                <a href="tel:8(7282)41-36-35" class="footer-contacts__link phone-number">
                                    <svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M1.30407 6.60573C1.77204 6.33427 2.3765 6.02947 2.92734 6.24855C3.35143 6.41523 3.61954 7.06293 3.89252 7.39154C4.03389 7.56299 4.19962 7.5868 4.41411 7.50108C5.99838 6.88672 7.21217 5.85326 8.08473 4.42928C8.23097 4.21021 8.2066 4.034 8.02624 3.82921C7.76301 3.52441 7.43153 3.18151 7.35841 2.77194C7.28529 2.36237 7.48515 1.88612 7.65577 1.51941C7.87513 1.05269 8.12373 0.390705 8.60145 0.124007C9.04017 -0.11888 9.62026 0.0192319 10.0102 0.328793C10.6829 0.866952 11.0095 1.70515 10.9998 2.54334C10.9998 2.78147 10.9657 3.01483 10.912 3.24343C10.7756 3.79587 10.5172 4.30546 10.2247 4.79599C10.0054 5.1627 9.76162 5.51989 9.50327 5.86755C8.65507 6.99149 7.60214 7.9678 6.38348 8.70122C5.77414 9.06793 5.11606 9.38702 4.43848 9.60609C3.67804 9.85374 2.99558 10.1062 2.17176 9.95375C1.30895 9.79183 0.460754 9.27272 0.119528 8.45833C0.0171595 8.22021 -0.0315857 7.94875 0.0220356 7.69634C0.139028 7.17247 0.865351 6.85814 1.2992 6.60573H1.30407Z" fill="white"/>
                                    </svg>
                            ...
                            <li class="footer-contacts__item">
                                ...
                                <a href="https://instagram.com/aghl_kz/" class="footer-contacts__link instagramm" target="_blank">
                                    ...
                                    <path d="M7.25815 3.84009C5.30403 3.84009 3.71283 5.4326 3.71283 7.38831C3.71283 9.34402 5.30403 10.9365 7.25815 10.9365C9.21226 10.9365 10.8035 9.34402 10.8035 7.38831C10.8035 5.4326 9.21226 3.84009 7.25815 3.84009ZM7.25815 9.66066C6.00503 9.66066 4.98766 8.64245 4.98766 7.38831C4.98766 6.13417 6.00814 5.11596 7.25815 5.11596C8.50816 5.11596 9.52864 6.13727 9.52864 7.38831C9.52864 8.63934 8.51126 9.66066 7.25815 9.66066Z" fill="white"/>
                            ...
                            <li class="footer-contacts__item">
                                ...
                                <a href="https://maps.app.goo.gl/pwTDJpVrYXxqen7Y6" class="footer-contacts__link location" target="_blank">

                                    <svg width="14" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.84136 0.851193C6.66386 0.0613404 5.36854 0 4.99965 0C4.63076 0 3.33544 0.0613404 2.15794 0.851193C0.725857 1.81144 0 3.30329 0 5.28663C0 9.59334 4.19104 13.4449 4.96248 13.9743L5.00035 14L5.03822 13.9743C5.80966 13.4449 10.0007 9.59258 10.0007 5.28663C10.0007 3.30405 9.27484 1.81144 7.84206 0.851193H7.84136ZM4.99965 7.35933C3.73028 7.35933 2.69794 6.2446 2.69794 4.87391C2.69794 3.50322 3.73028 2.38849 4.99965 2.38849C6.26902 2.38849 7.30135 3.50322 7.30135 4.87391C7.30135 6.2446 6.26902 7.35933 4.99965 7.35933Z" fill="white"/>
                                    </svg>
                                    Республика Казахстан, <br>
                                    Жетысуская область, <br>
                                    город Талдыкорган, <br>
                                    улица Абылайхана, д. 271а, кв. 21а.
                             ...
                             <li class="footer-contacts__item">
                                ...
                                <a href="tel:7(342)279-36-13" class="footer__call-link button" 
                               >Заказать звонок</a>
                             </li>
                        </ul>
